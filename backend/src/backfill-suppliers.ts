...
const SUPPLIERS: SupplierSpec[] = [
  ...
  { name: 'Anchor Foods Lanka', contactPerson: 'Dilan Fernando', email: 'trade@anchor.lk', phone: '011 267 3311', address: '77 Baseline Road, Colombo 09', categories: ['Dairy', 'Dairy & Eggs', 'Chilled Food'] },
  ...
  { name: 'Crysbro Poultry & Meats', contactPerson: 'Tharindu Alwis', email: 'orders@crysbro.lk', phone: '037 228 5500', address: 'Panaliya, Pannala', categories: ['Meat & Poultry', 'Meat'] },
  ...
  { name: 'Maliban Biscuit Manufactories', contactPerson: 'Roshan Mendis', email: 'orders@maliban.lk', phone: '011 246 5000', address: 'Ratmalana Industrial Zone, Ratmalana', categories: ['Biscuits', 'Snacks', 'Snacks & Biscuits', 'Confectionery'] },
...
const CATEGORY_SUPPLIER: Record<string, string> = {
  ...
  'Snacks & Biscuits': 'Maliban Biscuit Manufactories',
