...
const customersData = [
  ...
  },
  {
    ...
    name: 'Customer 006',
    avatar: 'C6',
    email: 'customer006@email.com',
    phone: '+94 71 666 6666',
    totalOrders: 15,
    totalSpent: 178000,
  ...
  },
  {
    ...
    name: 'Customer 007',
    avatar: 'C7',
    email: 'customer007@email.com',
    phone: '+94 71 777 7777',
    totalOrders: 21,
    totalSpent: 267000,
    lastPurchase: '2026-02-19',
  },
  {
    ...
    name: 'Customer 008',
    avatar: 'C8',
    email: 'customer008@email.com',
    phone: '+94 71 888 8888',
    totalOrders: 9,
    totalSpent: 98000,
    ...
    <div className="p-6 max-w-[1400px]">
      ...
      <div className="bg-white rounded-xl p-4 shadow-sm border border-[#e4e7ec] mb-6">
        <div className="flex gap-3">
          ...
          <select className="px-4 py-2 border border-[#e4e7ec] rounded-lg text-sm text-[#4a5565] bg-white focus:outline-none focus:ring-2 focus:ring-[#155dfc]">
            ...
            <option>Sort by: Total Spent (High to Low)</option>
            <option>Sort by: Total Spent (Low to High)</option>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-[#e4e7ec] overflow-hidden">
        <div className="px-5 py-4 border-b border-[#e4e7ec]">
          ...
          <p className="text-xs text-[#4a5565] mt-1">Showing {customersData.length} customers</p>
        </div>
            ...
            <tbody className="divide-y divide-[#e4e7ec]">
              {customersData.map((customer) => (
                <tr key={customer.id} className="hover:bg-[#f9fafb] transition-colors">
                  ...
                  <td className="px-5 py-4">
                    <div className="text-sm text-[#4a5565]">{customer.email}</div>
                  </td>
                  <td className="px-5 py-4">
                    <div className="text-sm text-[#4a5565]">{customer.phone}</div>
                  </td>
                  <td className="px-5 py-4">
                    <div className="text-sm font-medium text-[#101828]">{customer.totalOrders}</div>
                  </td>
                  <td className="px-5 py-4">
                  ...
                  <td className="px-5 py-4">
                    <div className="text-sm text-[#4a5565]">{customer.lastPurchase}</div>
                  </td>
                  <td className="px-5 py-4">
        ...
        <div className="px-5 py-4 border-t border-[#e4e7ec] flex items-center justify-between">
          <p className="text-sm text-[#4a5565]">Showing 1 to {customersData.length} of 1,248 customers</p>
