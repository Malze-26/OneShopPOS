          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-[#e4e7ec]">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label htmlFor="sku" className="block text-sm font-medium text-[#101828] mb-2">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-[#e4e7ec]">
              ...
              <div className="grid grid-cols-2 gap-4">
                {/* Selling Price */}
                <div>
                  <label htmlFor="sellingPrice" className="block text-sm font-medium text-[#101828] mb-2">
                    Selling Price (LKR)
                  </label>
                  <input
                    id="sellingPrice"
                ...
                {/* Cost Price */}
                <div>
                  <label htmlFor="costPrice" className="block text-sm font-medium text-[#101828] mb-2">
                    Cost Price (LKR)
                  </label>
                  <input
                    id="costPrice"
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-[#e4e7ec]">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="initialStock" className="block text-sm font-medium text-[#101828] mb-2">
                    Initial Stock Quantity
                  </label>
                  <input
                    id="initialStock"
                ...
                {/* Low Stock Threshold */}
                <div>
                  <label htmlFor="lowStockThreshold" className="block text-sm font-medium text-[#101828] mb-2">
                    Low Stock Threshold
                  </label>
                  <input
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-[#e4e7ec]">
              ...
              <div className="border-2 border-dashed border-[#e4e7ec] rounded-lg p-8 text-center hover:border-[#155dfc] hover:bg-[#eff4ff]/30 transition-colors cursor-pointer">
                ...
                <p className="text-sm font-medium text-[#101828] mb-1">
