                ...
                <tr key={employee.id} className="hover:bg-[#f9fafb] transition-colors">
                  ...
                  <td className="px-5 py-4">
                    <span
                      ...
                      style={{
                        backgroundColor: roleConfig[employee.role as keyof typeof roleConfig].bg,
                        color: roleConfig[employee.role as keyof typeof roleConfig].text,
                      }}
                    >
                      {employee.role}
                    </span>
                  ...
                  <td className="px-5 py-4">
                    <span
                      ...
                      style={{
                        backgroundColor: statusConfig[employee.status as keyof typeof statusConfig].bg,
                        color: statusConfig[employee.status as keyof typeof statusConfig].text,
                      }}
                    >
