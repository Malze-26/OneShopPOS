      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-[#e4e7ec] mb-6">
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-[#101828] mb-1">{user?.name ?? 'User'}</h1>
              <p className="text-sm text-[#4a5565]">{user?.role ?? 'Store Manager'}</p>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-[#101828]">{user?.email ?? 'user@oneshop.lk'}</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-[#e4e7ec]">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm font-medium text-[#101828]">{user?.role ?? 'Store Manager'}</p>
            </div>
            <div>
