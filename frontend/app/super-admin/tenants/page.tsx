            ...
            {filteredTenants.map((tenant) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-4">
                  <span
                    className={`px-2 py-0.5 rounded-full text-xs font-medium ${getStatusBadge(tenant.status)}`}
                  >
                    {tenant.status}
                  </span>
                ...
                <div className="flex gap-3 pt-3 border-t border-gray-100">
                  <button
                    onClick={() => router.push(`/super-admin/tenants/${tenant._id}`)}
                    className="flex items-center gap-1 text-sm text-blue-600 hover:text-blue-800"
                  >
                    <Eye size={15} /> View
                  </button>
                  <button
                    onClick={() => router.push(`/super-admin/tenants/${tenant._id}/edit`)}
