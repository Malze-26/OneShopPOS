          ...
          <form onSubmit={handleProfileSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 outline-none text-sm"
            ...
            <div className="flex items-center gap-3 pt-2">
              <button
                ...
                className="px-5 py-2 text-white text-sm font-medium rounded-lg transition disabled:opacity-60"
