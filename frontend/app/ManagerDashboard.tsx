        ...
        <div className="lg:col-span-2 bg-white rounded-xl p-5 shadow-sm border border-[#e4e7ec]">
          ...
          <ResponsiveContainer width="100%" height={240}>
            <LineChart data={salesTrendData}>
              ...
              />
              <Line type="monotone" dataKey="sales" stroke="#155dfc" strokeWidth={2} fill="url(#colorSales)" />
            </LineChart>
          </ResponsiveContainer>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-10 gap-6">
          ...
          <div className="space-y-3">
            {employeePerformance.map((employee) => (
              <div key={employee.name} className="relative">
                ...
                <div className="absolute inset-0 bg-[#eff4ff] rounded" style={{ width: `${employee.performance}%`, zIndex: 0 }} />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="lg:col-span-3 bg-white rounded-xl p-5 shadow-sm border border-[#e4e7ec]">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/orders" className="text-sm text-[#155dfc] hover:underline font-medium">
              View All
            </Link>
          </div>
          <div className="space-y-3">
              ...
              <div key={order.id} className="flex items-center gap-3 p-2 hover:bg-[#f9fafb] rounded-lg transition-colors cursor-pointer">
                ...
                <div className="text-right">
                  ...
                  <span
                    ...
                    style={{
                      backgroundColor: statusColors[order.status as keyof typeof statusColors].bg,
